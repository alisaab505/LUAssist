@extends('layouts.app')
@section('title', 'Manage class - LUAssist')
@section('content')
<style>
    body {
        padding-top: 70px;
...
<div class="container-fluid">
    <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar sidenav">
                ...
                <div class="tab-pane fade" id="students-tab" role="tabpanel" aria-labelledby="students-tab">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $s->ext_name }} {{ $s->given_name }} {{ $s->middle_name }} {{ $s->family_name }}  
                                </td>
                                <td>
