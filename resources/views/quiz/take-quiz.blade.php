...
<head>
    ...
    <title>{{ $quiz->quiz_event_name }} - LUAssist</title>
            ...
            <div class="row">
                <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
                    <div id="timer" class="timer">
                        <p>Time Remaining: <span id="countdown">5:00</span></p>
                    </div>
                    <ul class="nav nav-pills flex-column">
                        <li class="nav-item disabled"><a class="nav-link disabled" style="font-size: 2rem; text-align: center">LUAssist</a></li>
                        <li class="nav-item">
                ...
                <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
                    <form class="tab-content col" id="v-pills-tabContent" action="/take" method="POST">
                        ...
                        <div class="tab-pane fade show active" id="welcome" role="tabpanel" aria-labelledby="welcome">
                            ...
                            <p>Name: <b>{{ $user_profile->ext_name }} {{ $user_profile->given_name }} {{ $user_profile->middle_name }} {{ $user_profile->family_name }}   </b></p>
